...
from gym_av_aloha.env.tasks.peg_insertion_env_eval import PegInsertionEnv
import gym_av_aloha.env.sim_config 
...
def eval(args):
    ...
    n_interpolation_steps = round(8.3333 / policy.task_cfg.fps)
    ...
    env = gym.make("gym_av_aloha/peg-insertion-v1", cameras=CAMERAS, fps=25)
    ...
    #env = AVAlohaEnv(init_node=True, stereo_cam_idx=18)
...
def main():
    ...
    parser.add_argument('--policy', type=str, default="/home/jinyu/GitHub/gaze-av-aloha/outputs/2025-08-24_17-10-51_fov-unet-augementation_insertion_peg_Ian/checkpoints/0000030000", help='Path to the policy checkpoint directory parent folder of policy/model.safetensors')
