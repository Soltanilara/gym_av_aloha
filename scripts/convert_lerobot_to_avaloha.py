...
def main():
    ...
    #     type=str,
    #     default=None,
    #     help="Root directory for the new dataset. If None, defaults to the repo ID.",
    # )
    # parser.add_argument(
    #     "--start_episode",
    #     type=int,
    ...
    create_av_aloha_dataset_from_lerobot(
        datasets= [
            LeRobotDataset(
                repo_id="iantc104/wmil_pusht",
                # root="/home/ianchuang/wmil/data/outputs/iantc104/wmil_noisy_pusht"
            ),
        ],
        repo_id="iantc104/wmil_pusht",
        image_size=(84,84),
