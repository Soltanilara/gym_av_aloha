...
def main():
    episodes = {
        ...
        "iantc104/av_aloha_sim_hook_package": list(range(0, 50)),
        "iantc104/av_aloha_sim_pour_test_tube": list(range(0, 50)),
        "iantc104/av_aloha_sim_slot_insertion": list(range(0, 75)),
        "iantc104/av_aloha_sim_peg_insertion": list(range(0, 50)),
    }
